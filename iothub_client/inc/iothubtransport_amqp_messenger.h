...
extern "C"
{
	...
	MOCKABLE_FUNCTION(, int, messenger_send_async, MESSENGER_HANDLE, messenger_handle, IOTHUB_MESSAGE_LIST*, message, ON_EVENT_SEND_COMPLETE, on_event_send_complete_callback, const void*, context);
